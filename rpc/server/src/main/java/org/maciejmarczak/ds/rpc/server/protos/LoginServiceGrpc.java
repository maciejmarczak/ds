...
public final class LoginServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<org.maciejmarczak.ds.rpc.server.protos.LoginServiceOuterClass.LoginRequest,
      org.maciejmarczak.ds.rpc.server.protos.User> METHOD_LOGIN =
      io.grpc.MethodDescriptor.<org.maciejmarczak.ds.rpc.server.protos.LoginServiceOuterClass.LoginRequest, org.maciejmarczak.ds.rpc.server.protos.User>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "LoginService", "Login"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.maciejmarczak.ds.rpc.server.protos.LoginServiceOuterClass.LoginRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.maciejmarczak.ds.rpc.server.protos.User.getDefaultInstance()))
          .build();
  ...
  public static abstract class LoginServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(org.maciejmarczak.ds.rpc.server.protos.LoginServiceOuterClass.LoginRequest request,
        io.grpc.stub.StreamObserver<org.maciejmarczak.ds.rpc.server.protos.User> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.maciejmarczak.ds.rpc.server.protos.LoginServiceOuterClass.LoginRequest,
                org.maciejmarczak.ds.rpc.server.protos.User>(
                  this, METHODID_LOGIN)))
          .build();
    }
  }
  ...
  public static final class LoginServiceBlockingStub extends io.grpc.stub.AbstractStub<LoginServiceBlockingStub> {
    ...
    /**
     */
    public org.maciejmarczak.ds.rpc.server.protos.User login(org.maciejmarczak.ds.rpc.server.protos.LoginServiceOuterClass.LoginRequest request) {
  ...
  public static final class LoginServiceFutureStub extends io.grpc.stub.AbstractStub<LoginServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.maciejmarczak.ds.rpc.server.protos.User> login(
        org.maciejmarczak.ds.rpc.server.protos.LoginServiceOuterClass.LoginRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((org.maciejmarczak.ds.rpc.server.protos.LoginServiceOuterClass.LoginRequest) request,
              (io.grpc.stub.StreamObserver<org.maciejmarczak.ds.rpc.server.protos.User>) responseObserver);
          break;
        default:
  ...
  private static final class LoginServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.maciejmarczak.ds.rpc.server.protos.LoginServiceOuterClass.getDescriptor();
    }
  }
